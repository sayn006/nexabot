            ...
            {[
              {
                ...
                desc: "Application de sécurité connectée pour agents terrain. Suivi GPS en temps réel, gestion des rondes, alertes automatiques et monitoring des interventions via dashboard web et app mobile.",
              ...
              },
              {
                ...
                desc: "Plateforme de gestion transport pour chauffeurs et dispatchers. Suivi de missions, navigation GPS, planning des livraisons et reporting temps réel pour une flotte de véhicules.",
              ...
              },
              {
                ...
                desc: "Outil de gestion et time tracking pour équipes. Suivi des heures par collaborateur et projet, tableaux de bord analytiques, résumé global mensuel et gestion de la facturation.",
              ...
              },
              {
                ...
                desc: "Solution complète pour restaurant : site vitrine avec commande en ligne, application mobile client iOS & Android, et backoffice admin pour gérer le menu, les commandes et les réservations.",
              ...
              },
              {
                ...
                desc: "Plateforme de gestion B2B pour distributeur alimentaire. Gestion des commandes clients, suivi des stocks, livraisons, facturation et tableau de bord commercial pour l'équipe interne.",
                tech: ["Symfony", "MySQL", "Hostinger", "PHP", "Bootstrap"],
              },
            ].map((project) => (
